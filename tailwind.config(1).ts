	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'gradient-revolution': 'var(--gradient-revolution)',
				'gradient-freedom': 'var(--gradient-freedom)',
				'gradient-unity': 'var(--gradient-unity)'
			},
			boxShadow: {
				'revolution': 'var(--shadow-revolution)',
			...
			animation: {
				...
				'revolution-rise': 'revolution-rise 0.8s ease-out',
